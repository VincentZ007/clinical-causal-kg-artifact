...
\smallskip\noindent\textbf{Causal-screen coverage.} Across the 932 lift-only questions, the retriever returns 9{,}253 top-12 candidate slots. The screen changes evidence order in 678 questions (72.7\%) while preserving recall by construction:
\begin{center}
\scriptsize
